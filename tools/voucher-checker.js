                ...
                popup.innerHTML = `
                    ...
                    <div style="margin-bottom:10px;">
                        <div style="position:relative;">
                            <textarea id="voucherLinkInput" placeholder="Dán link hoặc ID — mỗi dòng 1 cái" rows="3" style="width:100%;padding:12px 14px;border: 2px solid #f3f4f6;border-radius: 12px;font-size:13.5px;line-height:1.5;box-sizing:border-box;outline:none;background:#fafafa;"></textarea>
                        ...
                        <div id="voucherActionRow" style="display:flex;gap:10px;margin-top:10px;">
                            <button id="loadVoucherBtn" style="flex:1;background:#EE4D2D;color:#fff;border:none;padding:10px 16px;border-radius:10px;cursor:pointer;font-weight:700;font-size:13px;letter-spacing:.2px;">Check</button>
                            <button id="scanBannerBtn" hidden style="display:none;flex:1;background:#0ea5e9;color:#fff;border:none;padding:10px 16px;border-radius:10px;cursor:pointer;font-weight:700;font-size:13px;letter-spacing:.2px;">Quét Banner</button>
                            <button id="viewBannerBtn" hidden style="display:none;flex:1;background:#6366f1;color:#fff;border:none;padding:10px 16px;border-radius:10px;cursor:pointer;font-weight:700;font-size:13px;letter-spacing:.2px;">Xem Banner</button>
